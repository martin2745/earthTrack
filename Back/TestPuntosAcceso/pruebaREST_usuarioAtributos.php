<?php
    ...
    class usuarioAtributos{
        function insertar(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_Insertar_Atributos.php';
        ...
        function borrar(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_Borrar_Atributos.php';
        ...
        function buscar(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_Buscar_Atributos.php';
        ...
        function editar(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_Editar_Atributos.php';
        ...
        function editarContrasena(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_EditarContrasena_Atributos.php';
        ...
        function verEnDetalle(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_VerEnDetalle_Atributos.php';
        ...
        function reactivar(){
            include_once './Testeo/GestionUsuarios/Atributos/pruebaREST_Usuario_Reactivar_Atributos.php';
