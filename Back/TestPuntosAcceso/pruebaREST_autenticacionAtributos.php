<?php
    ...
    class autenticacionAtributos{
        function login(){
            include_once './Testeo/Autenticacion/Atributos/pruebaREST_Login_Atributos.php';
        ...
        function registrar(){
            include_once './Testeo/Autenticacion/Atributos/pruebaREST_Registro_Atributos.php';
        ...
        function obtenerContrasenaCorreo(){
            include_once './Testeo/Autenticacion/Atributos/pruebaREST_ObtenerContrasenaCorreo_Atributos.php';
