...
function ajustarCookies() {
  ...
  function cargarInformacionBusqueda() {
    if (getCookie("id_categoria") != "") {
      document.getElementById("id_categoria_BUSQUEDA").value = getCookie("id_categoria");
    } else {
  ...
  */
  ...
  function construyeFila(fila) {
    ...
    var celdaAccionNavegar = '<div class="tooltip6"><img class="eliminar ICONO_NAVEGAR_PROCESO" src="images/rol.png" onclick="navigateToProcesos(' +
    fila.id_categoria +
  ...
  */
  ...
  function mostrarObligatorios() {
    ...
    $("#obligatorio_responsable_categoria").attr("style", "display: inline-block");
  }
  ...
  */
  ...
  function showDetalle(id, nombre_categoria, descripcion,id_padre,nombre_padre,dni,nombre,borrado_logico) {
    ...
    rellenarFormulario(id, nombre_categoria, descripcion,dni,nombre, borrado_logico);
   ...
   * carga como corresponda los label, input y campo obligatorio.*/
  function showEditar(id, nombre_categoria, descripcion,id_padre,nombre_padre,dni,nombre,borrado_logico) {
    limpiarSelect();
    
    rellenaSelectCategoriaPadre(id_padre,nombre_padre);
    rellenaSelectUsuarioResponsable(dni,nombre);
    var idioma = getCookie("lang");
    var campos = ["input_categoria_id", "input_categoria_nombre", "input_categoria_borrado_logico"];
    ...
    rellenarFormulario(id, nombre_categoria, descripcion,id_padre,dni,nombre,borrado_logico);
    deshabilitaCampos(campos);
    $("#formularioAcciones").modal("show");
    setLang(idioma);
  }
   ...
   * carga como corresponda los label, input y campo obligatorio.*/
  function showEliminar(id, nombre_categoria, descripcion,id_padre,nombre_padre,dni,nombre,borrado_logico) {
   ...
   * carga como corresponda los label, input y campo obligatorio.*/
  function showReactivar(id, nombre, descripcion,id_padre,nombre_padre,dni,nombre, borrado_logico) {
    var idioma = getCookie("lang");
    var campos = [
      "input_categoria_id",
      "input_categoria_nombre",
    ...
    rellenarFormulario(id, nombre, descripcion,id_padre,dni,nombre,borrado_logico);
    deshabilitaCampos(campos);
    $("#formularioAcciones").modal("show");
    setLang(idioma);
  }
  ...
  function rellenarFormulario(id, nombre_categoria, descricion,dni,nombre,borrado_logico) {
  ...
  */
  ...
  function cambiarOnBlurCampos(onBlurId, onBlurNombre, onBlurdescripcion,onBlurCategoriaPadre,onBlurResponsable) {
    if (onBlurId != "") {
    ...
    if (onBlurResponsable != "") {
      $("#select_responsable_insertar_categoria").attr("onblur", onBlurResponsable);
    }
  }
  ...
  */
  ...
  function editEntidadAjaxPromesa() {
    ...
    habilitaCampos(["input_categoria_id", "input_categoria_nombre", "input_categoria_descripcion","select_padre_insertar_categoria","select_padre_insertar_categoria"]);
    if (token == null) {
      errorAutenticado("ACCESO_DENEGADO");
    } else {
      return new Promise(function (resolve, reject) {
