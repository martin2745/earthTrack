...
async function accionesPermitidas() {
            ...
            '<div class="card">' +
              '<img src="images/categorias.png" class="card-img-top" alt="Noticias">' +
                '<div class="card-body-news">' +
                  ...
                  '<p class="card-text responsable" style="font-style: italic;">'+categoria.usuario.email+'</p>' +
                "</div>" +
                '<div class="card-footer">';

    var opcionAdd='<form name="formCategoria'+categoria.id_categoria+'" id="formCategoriaAñadir'+categoria.id_categoria+'" action="javascript:showAdd('+atributosFunciones+')" onsubmit="">'+
                    '<input type="hidden" id="'+categoria.id_categoria+'" name="id" value="'+categoria.id_categoria+'">'+
                        '<button type="submit" name="btnCategoriasAñadir'+categoria.id_categoria+'"  class="btnCategorias'+categoria.id_categoria+' tooltip3" id="btnCategoriasAñadir'+categoria.id_categoria+'"">'+
     ...
     var opcionEdit='<form name="formCategoria'+categoria.id_categoria+'" id="formCategoriaEditar'+categoria.id_categoria+'" action="javascript:showEditar('+atributosFunciones+')" onsubmit="">'+
                        '<button type="submit" name="btnCategoriasEditar'+categoria.id_categoria+'"  class="btnCategorias'+categoria.id_categoria+' tooltip3" id="btnCategoriasEditar'+categoria.id_categoria+'"">'+
      ...
      var opcionDelete='<form name="formCategoria'+categoria.id_categoria+'" id="formCategoriaEliminar'+categoria.id_categoria+'" action="javascript:showEliminar('+atributosFunciones+')" onsubmit="">'+
                        '<button type="submit" name="btnCategoriasEliminar'+categoria.id_categoria+'"  class="btnCategorias'+categoria.id_categoria+' tooltip3" id="btnCategoriasEliminar'+categoria.id_categoria+'"">'+
      ...
      var opcionCrearProceso='<form name="formProcesodeCategoria'+categoria.id_categoria+'" id="formProcesoInsertar'+categoria.id_categoria+'" action="javascript:showAddProceso('+"'"+categoria.id_categoria+"'"+','+"'"+categoria.nombre_categoria+"'"+')" onsubmit="">'+
                    '<button type="submit" name="btnCrearProceso'+categoria.id_categoria+'"  class="btnProcesos'+categoria.id_categoria+' tooltip3" id="btnProcesosInsertar'+categoria.id_categoria+'"">'+
                        '<img class="iconoEntrar iconEntrar" src="images/rol.png"/>'+
                        '<span class="tooltiptext3 INSERTAR_PROCESO"></span>'+
                    '</button>'+
                '</form>'; 

       var opcionVerProceso='<form name="formProcesodeCategoria'+categoria.id_categoria+'" id="formProcesoInsertar'+categoria.id_categoria+'" action="javascript:actualizarConProceso('+atributosFunciones+')" onsubmit="">'+
                    '<button type="submit" name="btnCrearProceso'+categoria.id_categoria+'"  class="btnProcesos'+categoria.id_categoria+' tooltip3" id="btnProcesosInsertar'+categoria.id_categoria+'"">'+
                        '<img class="iconoEntrar iconEntrar" src="images/rol.png"/>'+
       ...
       var opcionSeguirNavegando='<form name="formCategoria'+categoria.id_categoria+'" id="formCategoria'+categoria.id_categoria+'" action="javascript:actualizarPaginaConNuevasCategorias('+"'"+categoria.id_categoria+"'"+','+"'"+id_categoria_padre+"'"+')" onsubmit="">'+
     ...
     var tarjetaFinal=
      ...
      if(acciones.includes("borrar") && categoria.id_categoria!=1 && !categoria.tiene_proceso && !categoria.tiene_hijos){
        tarjeta2=tarjeta2+opcionDelete;
      }
      
      if(categoria.id_categoria!=1 && !categoria.tiene_proceso && !categoria.tiene_hijos){
            ...
            '<div class="card">' +
              '<img src="images/news.png" class="card-img-top" alt="Noticias">' +
                '<div class="card-body-news">' +
                  ...
                  '<p class="card-text responsable" style="font-style: italic;">'+proceso.formula+'</p>' +
                  '<p class="card-text responsable" style="font-style: italic;">'+proceso.id_categoria.nombre_categoria+'</p>' +
                "</div>" +
                '<div class="card-footer">';

     var opcionEdit='<form name="formproceso'+proceso.id_proceso+'" id="formprocesoEditar'+proceso.id_proceso+'" action="javascript:showEditarProceso('+atributosFunciones+')" onsubmit="">'+
                        '<button type="submit" name="btnprocesosEditar'+proceso.id_proceso+'"  class="btnprocesos'+proceso.id_proceso+' tooltip3" id="btnprocesosEditar'+proceso.id_proceso+'"">'+
                            '<img class="iconoEntrar iconEntrar" src="images/edit.png"/>'+
      ...
      var opcionDelete='<form name="formproceso'+proceso.id_proceso+'" id="formprocesoEliminar'+proceso.id_proceso+'" action="javascript:showBorrarProceso('+atributosFunciones+')" onsubmit="">'+
                        '<button type="submit" name="btnprocesosEliminar'+proceso.id_proceso+'"  class="btnprocesos'+proceso.id_proceso+' tooltip3" id="btnprocesosEliminar'+proceso.id_proceso+'"">'+
                            '<img class="iconoEntrar iconEntrar" src="images/delete.png"/>'+
  ...
  function actualizarConProceso(id, nombre, descripcion,id_padre,nombre_padre,dni,nombre_responsable,borrado_logico){
  ...
  function cambiarOnBlurCamposProceso(onBlurNombre, onBlurDescripcion,onBlurFormula,onBlurCategoriaProceso) {
    if (onBlurNombre != "") {
  ...
  function rellenarFormularioProcesos(id, nombre, descripcion,formula,id_categoria,nombre_categoria,borrado_logico) {
...
function formatoAddProceso(id_categoria,nombre_categoria){
  ...
  function showAddProceso(id_categoria,nombre_categoria){
    ...
    var camposHabilitados=["input_proceso_nombre","input_proceso_descripcion","input_proceso_formula","select_categoria_insertar_proceso"];
  ...
  function showEditarProceso(id, nombre_proceso, descripcion,formula,id_categoria,nombre_categoria,borrado_logico){
    ...
    var camposHabilitados=["input_proceso_descripcion","input_proceso_formula","select_categoria_insertar_proceso"];
    limpiarErroresModalProceso();
    cambiarFormularioProceso(
      "editForm",
    ...
    cambiarIconoProceso("images/edit.png", "ICONO_EDIT", "iconoEditarRol", "Editar");
    rellenarFormularioProcesos(id, nombre_proceso, descripcion,formula,id_categoria,nombre_categoria,borrado_logico);
  ...
  function showBorrarProceso(id, nombre_proceso, descripcion,formula,id_categoria,nombre_categoria,borrado_logico){
    ...
    var idioma = getCookie("lang");
    var campos = ["input_proceso_id", "input_proceso_nombre","input_proceso_descripcion", "input_proceso_borrado_logico","select_categoria_insertar_proceso","input_proceso_formula"];
    limpiarErroresModalProceso();
    cambiarFormularioProceso("deleteForm", "javascript:deleteEntidadProceso();", "");
    cambiarIconoProceso(
      "images/delete.png",
      "ICONO_ELIMINAR",
      "iconoEliminar",
  ...
  function parsearFormula(){
    ...
    if(!comprobarLLavesParentesis(formula)){
      console.log("LLAVES O PARENTESIS MAL CERRADOS");
      valid=false;
    }
    ...
    if(!checkCaractetesFormula(formulaTransformada)){
        console.log("ERROR formato formula");
        valid=false;
    }
   ...
   * carga como corresponda los label, input y campo obligatorio.*/
  function showEditar(id, nombre, descripcion,id_padre,nombre_padre,dni,nombre_responsable,borrado_logico) {
    usuariosNoResponsablesSistema();
   
    rellenaSelectCategoriaPadre(id_padre,nombre_padre);
    rellenaSelectUsuarioResponsable(dni,nombre_responsable);
    var idioma = getCookie("lang");
    var campos = ["input_categoria_id", "input_categoria_nombre", "input_categoria_borrado_logico","select_padre_insertar_categoria"];
    editEstructura();
    cambiarFormulario(
      "editForm",
    ...
    rellenarFormulario(id, nombre, descripcion, id_padre,borrado_logico,dni,nombre_responsable);
    deshabilitaCampos(campos);
    $("#formularioAcciones").modal("show");
    setLang(idioma);
  }
   ...
   * carga como corresponda los label, input y campo obligatorio.*/
  function showEliminar(id, nombre, descripcion,id_padre,nombre_padre,dni,nombre_responsable,borrado_logico,id_padre) {
...
function explorarCategorias() {
    ...
    */
     ...
     if(!$.isEmptyObject(getCookie("id_padre_actual")) && getCookie("id_padre_actual")!==categoria_padre.id){
    ...
    */
    ...
    if(id_padre_previo!=categoriaActual.id_padre.id_categoria){
     ...
     // explorarCategorias(id_padre_previo);
      ...
      id_padre_previo=arrayPadresPervios.push(categoriaActual.id_padre.id_categoria);
      setCookie('id_padre_previo',JSON.stringify(arrayPadresPervios));
  ...
  async function usuariosNoResponsablesSistema() {
    ...
    await usuariosNoResponsablesSistemaAjaxPromesa()
      .then((res) => {
        ...
        i=0;
        res.resource.forEach((element) => {
          if (element.borrado_logico == 0 && element.id_rol.nombre_rol=="usuario") {
  ...
  function editEntidadAjaxPromesa() {
    ...
    habilitaCampos(["input_categoria_id", "input_categoria_nombre", "input_categoria_descripcion","select_padre_insertar_categoria","select_responsable_insertar_categoria"]);
    if (token == null) {
      errorAutenticado("ACCESO_DENEGADO");
    } else {
      return new Promise(function (resolve, reject) {
  ...
  async function editEntidad() {
    ...
    let idElementoList = [
      ...
      "input_categoria_nombre",
      "input_categoria_descripcion",
      "input_categoria_borrado_logico","select_padre_insertar_categoria",
      "select_responsable_insertar_categoria",
    ];
  ...
  function addEntidadProcesoAjaxPromesa() {
    var token = getCookie("token");
    addActionControler(document.formularioGenericoProcesos, "insertar", "proceso");
    if (token == null) {
      errorAutenticado("ACCESO_DENEGADO");
    } else {
      return new Promise(function (resolve, reject) {
