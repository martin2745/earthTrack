arrayEN = {
  ...
  CONTENIDO_NOTICIA_3:
   ...
   CATEGORIA_NOMBRE_MENOR_QUE_3:'Name length must be between 3 and 48 characters',
   CATEGORIA_NOMBRE_MAYOR_QUE_48:'Name length must be between 3 and 48 characters',
   CATEGORIA_DESCRIPCION_MAYOR_QUE_200:'The description has a maximum of 200 characters',
   ...
   CATEGORIA_DESCRIPCION_FORMATO_INCORRECTO:'Incorrect format of the description',
   ...
   CATEGORIA_REACTIVAR_OK:'Category has been reactivated',
   ...
   NOTAS_FORMULA_PROCESO: 'Note: in order to fulfill this formula introduce the parameters between keys indicating their unity with backets. ',
   ...
   FORMULA_PARAMETROS_MAL: 'The parameters are not formatted propperly, please check the note below.',
    FORMULA_MAL_FORMADA : 'There is some errors on the formula. The operators available are +,-,*,/,^',
    PARAMETRO_FORMULA_VACIO: 'There can not be empty parameters',
    FORMULA_PARENTESIS_MAL : 'There is parentheses or keys in the formula that do not match',
    ...
    PROCESO_CALCULADO:'You have already filled this process, to check the process that currently shape your track go to "My Process"',
