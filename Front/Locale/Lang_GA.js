arrayGA = {
  ...
  CONTENIDO_NOTICIA_3:
   ...
   CATEGORIA_RESPONSABLE_VACIO:'Debes escoller un responsable para esta categoría',
   CATEGORIA_NOMBRE_MENOR_QUE_3:'A lonxitude do nome debe ser entre 3 e 48 caracteres',
   CATEGORIA_NOMBRE_MAYOR_QUE_48:'A lonxitude do nome debe ser entre 3 e 48 caracteres',
   CATEGORIA_DESCRIPCION_MAYOR_QUE_200:'A descripción non pode ter mais de 200 caracteres',
   CATEGORIA_NOMBRE_SOLO_LETRAS:'O nome solo admite letras, sen espacios',
   CATEGORIA_DESCRIPCION_FORMATO_INCORRECTO:'A descripción ten un formato incorrecto.',
   ...
   CATEGORIA_NOMBRE_FORMATO_INCORRECTO: 'O formato do nome da categoria e incorrecto',
   NOMBRE_CATEGORIA:'Nome da categoria',
      ...
      CATEGORIA_REACTIVAR_OK:'A categoria reactivaouse correctamente',
      ...
      NOTAS_FORMULA_PROCESO: 'Nota: para escribir a fórmula introduce os parámetros entre chaves. Non e necesario indicar a unidade.',
   ...
   CATEGORIA_NOMBRE_MAYOR_QUE_48:'A lonxitude do nome debe ser entre 3 e 48 caracteres',
   CATEGORIA_NOMBRE_MENOR_QUE_3:'A lonxitude do nome debe ser entre 3 e 48 caracteres',
   PROCESO_DESCRIPCION_FORMATO_INCORRECTO:'A descripción ten un formato incorrecto.',
   NOMBRE_PROCESO_FORMATO_INCORRECTO:'O nome ten un formato incorrecto.',
   FORMULA_PARAMETROS_MAL: 'Os parámetros introducironse de forma incorrecta, por favor mire a nota que indica cómo facelo',
FORMULA_MAL_FORMADA : 'A formula está mal formada. Os operadores dispoñibles son +,-,*,/,^',
...
PROCESO_CALCULADO:'Vostede xa añadiu este proceso a súa pegada de carbono, para revisar os procesos que a forman pode visitar o apartado "Meus procesos"',
